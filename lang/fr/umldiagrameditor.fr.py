...
class InsertUmlDiagramPlugin(PluginClass):
...
class BackwardUmlDiagramImageObjectType(BackwardImageGeneratorObjectType):
...
class UmlDiagramGenerator(ImageGeneratorClass):
