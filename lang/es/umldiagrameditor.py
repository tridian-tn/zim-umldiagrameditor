...
class InsertPlantumlPlugin(PluginClass):
	...
	plugin_info = {
		'name': _('Insertar diagrama UML'), # T: plugin name
		'description': _('''\
Este plugin permite la edición de diagramas UML con PlantUML.
'''), # T: plugin description
        'help': 'Plugins:Editor de diagramas UML',
		'author': 'Voyvode',
	}
