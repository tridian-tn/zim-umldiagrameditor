...
dotcmd = ('plantuml')
# Windows fix with scoop-sourced PlantUML: resolve the dependency with 'plantuml', but use 'plantuml.cmd' to run it
dotcmdwithext = ('plantuml.cmd' if os.name == 'nt' else 'plantuml')
